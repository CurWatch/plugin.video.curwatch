...
VIDEOS = {'Live Television': [{'name': 'CBA Television',
                       ...
                       'video': 'http://cba.cdn.cur.watch/mystream.m3u8',
                       'genre': 'Live Television'},
                      {'name': 'Telecuracao',
                       'thumb': 'https://cur.watch/images/tv_tc.png',
                       'fanart':'https://cur.watch/images/kodi_fanart.jpg',
                       'video': 'http://tc.cdn.cur.watch/mystream.m3u8',
                       'genre': 'Live Television'},
                      {'name': 'TCFM Telecuracao FM',
                       'thumb': 'https://cur.watch/images/tv_tcfm.png',
                       'fanart':'https://cur.watch/images/kodi_fanart.jpg',
                       'video': 'http://encoder.iviplanet.com:1935/iosplaylist?application/TCFMNew.m3u8',
                       'genre': 'Live Television'},
						{'name': 'Nos Pais TV',
                       'thumb': 'https://cur.watch/images/tv_nospais.png',
                       'fanart':'https://cur.watch/images/kodi_fanart.jpg',
                       'video': 'http://highvolume04.streampartner.nl:1935/nos_pais_24_7/smil:livestream.stream.smil/playlist.m3u8',
                       'genre': 'Live Television'},
                       {'name': 'Rtv-7',
                       'thumb': 'https://cur.watch/images/tv_rtv7.png',
                       'fanart':'https://cur.watch/images/kodi_fanart.jpg',
                       'video': 'http://rtv7.cdn.cur.watch/mystream.m3u8',
                       'genre': 'Live Television'},
                       {'name': 'TV Direct 13',
                       'thumb': 'http://cur.watch/images/tv_tvd13.png',
                       'fanart':'https://cur.watch/images/kodi_fanart.jpg',
                       'video': 'http://livestream.5centscdn.com/tvdirect13live_mbt/tvd13001.stream/playlist.m3u8',
                       'genre': 'Live Television'},
                       {'name': 'TV Direct 13 [COLOR red]HD[/COLOR]',
                       'thumb': 'http://cur.watch/images/tv_tvd13.png',
                       'fanart':'https://cur.watch/images/kodi_fanart.jpg',
                       'video': 'http://livestream.5centscdn.com/tvdirect13live/dfd4c30108856fab7a1b3ef38ca653b1.sdp/playlist.m3u8',
                       'genre': 'Live Television'}
                      ],
            'Video On Demand': [{'name': 'E Notisia (CBA Television)',
                      'thumb': 'https://cur.watch/images/show_e-notisia.jpg',
                      'fanart':'https://cur.watch/images/kodi_fanart.jpg',
                      'video': 'https://cur.watch/api/last_episode/enotisia/kodi.mp4',
